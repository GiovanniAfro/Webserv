...
class Server : public ADirective {
	private:
		...
		std::string _getRewrite(std::string const &requestUri, std::string const &path, std::map<std::string, ADirective *> servDirs, std::map<std::string, ADirective *> locaDirs);
